...
const functions = {
    ...
    loadContract: async (args)=>{
        const { WhaleCoiner  } = await __webpack_require__.e(/* import() */ 898).then(__webpack_require__.bind(__webpack_require__, 1898));
    ...
    createUpdateTransaction: async (args)=>{
        const transaction = await snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .Mina.transaction */ .No.transaction(()=>{
            state.zkapp.update((0,snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .Field */ .gN)(100));
        });
    ...
    createWallTransaction: async (args)=>{
        const transaction = await snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .Mina.transaction */ .No.transaction(()=>{
...
/******/ 			return "static/chunks/" + (chunkId === 829 ? "cc8f0cfa" : chunkId) + "." + {"829":"186d21af885eea61","898":"fabceee3ff508d71"}[chunkId] + ".js";
/******/ 		};
/******/ 	}();
/******/ 	
...
/******/ 	!function() {
/******/ 		__webpack_require__.p = "/zkWhaleCoinerUI//_next/";
/******/ 	}();
/******/ 	
